...
=======
    <h1 className="h3 mb-5 font-weight-normal text-center ">Agregar grupo</h1>
>>>>>>> a29ab6d56cc7c33746051fc5bcdcbbfa8830f44a
    ...
    <input type="text" id="inputEmail" className="form-control mb-3" placeholder="Grado" required="" autofocus=""/>
    <label for="inputEmail" className="sr-only mb-3">Asignatura</label>
    <input type="text" id="inputEmail" className="form-control mb-3" placeholder="Asignatura" required="" autofocus=""/>
